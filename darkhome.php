  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#" class="scrollto"><img src ="icond.png"></a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <div class="social-fonts">
           ...
           <li><a href="home.php"><svg class="bi bi-brightness-high" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<li><a href="weather.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  ?>
   ...
   <!--card section-->
                             <P align="center"><h1>Tech NEWS Trending</h1></p1>
    ...
    <div class="container">
      <div class="section-title text-center">
          ...
          <div class="card-columns">
              ...
              <div class="card">
                <img src="bg3.jpg" class="card-img-top" alt="...">
              </div>
